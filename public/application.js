...
var config = {
  apiOrigins: {
    production: 'https://budget-tracker.herokuapp.com/',
...
var onChangePassword = function onChangePassword(event) {
  ...
  api.onChangePassword(data).then(ui.changePasswordSuccess).catch(ui.changePasswordFailure);
};

var onCreate = function onCreate(event) {
  event.preventDefault();
  var data = getFormFields(undefined);
  api.createBudgets(data);
  console.log('HELP ME!').then(ui.createBudgetsSuccess).catch(ui.createBudgetsFailure);
};

var onGetBudgets = function onGetBudgets(event) {
  event.preventDefault();
  api.getBudgets().then(ui.getBudgetsSuccess).then(function () {
    return onGetBudgets(event);
  }).catch(ui.failure);
  // $('#content').toggle()
};

var onClearBudgets = function onClearBudgets(event) {
  event.preventDefault();
  ui.clearBudgets();
};
...
var onUpdate = function onUpdate(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.updateBudgets(data).then(ui.updateBudgetsSuccess).then(function () {
    return onGetBudgets(event);
  }).catch(ui.updateBudgetsFailure);
  console.log('hello world');
};

var onRemoveBudgets = function onRemoveBudgets(event) {
  event.preventDefault();
  var id = event.target.dataset.id;
  api.removeBudgets(id).then(function () {
    return onGetBudgets(event);
  }).catch(ui.failure);
...
var createBudgets = function createBudgets(data) {
  console.log(data);
  data = {
    budget: data
  };
...
var clearBudgets = function clearBudgets() {
  return $.ajax({
    url: config.apiOrigin + '/budgets'
  });
};

var updateBudgets = function updateBudgets(data) {
  return $.ajax({
...
var removeBudgets = function removeBudgets(id) {
  return $.ajax({
...
var store = __webpack_require__(5);
var showBudgetsTemplate = __webpack_require__(16);
...
var changePasswordSuccess = function changePasswordSuccess(error) {
...
var createBudgetsSuccess = function createBudgetsSuccess(data) {
...
var createBudgetsFailure = function createBudgetsFailure(error) {
...
var updateBudgetsSuccess = function updateBudgetsSuccess(data) {
...
var updateBudgetsFailure = function updateBudgetsFailure(error) {
...
var getBudgetsSuccess = function getBudgetsSuccess(data) {
  console.log(data);
  var showBudgetsHtml = showBudgetsTemplate({ budgets: data.budgets });
...
// }
//
var deleteBudgets = function deleteBudgets(error) {
  console.error(error);
};
...
module.exports = {
  ...
  createBudgetsSuccess: createBudgetsSuccess,
  createBudgetsFailure: createBudgetsFailure,
  getBudgetsSuccess: getBudgetsSuccess,
  clearBudgets: clearBudgets,
  deleteBudgets: deleteBudgets,
  updateBudgetsSuccess: updateBudgetsSuccess,
  updateBudgetsFailure: updateBudgetsFailure
  // failure,
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <!-- "
    + ((stack1 = container.invokePartial(__webpack_require__(34),depth0,{"name":"partial","data":data,"blockParams":blockParams,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    ...
    + "\">\n  <div>\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),blockParams[0][0],{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </div>\n</ul>\n";
  ...
  return "    <li>ID: "
    ...
    + "</li>\n    <li>Store: "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.store : stack1), depth0))
    + "</li>\n    <li>Amount: "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.amount : stack1), depth0))
    + "</li>\n      <li>Date: "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.date : stack1), depth0))
    + "</li>\n      <!-- <li><button data-id=\""
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"delete\">Delete</button></li> -->\n      <li><button><a class=\"delete\" data-toggle=\"modal\" data-target=\"#deletemodal\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "\">Delete</a></button></li>\n        <li><button><a class=\"update\" data-toggle=\"modal\" data-target=\"#updateFormModal\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "\">update</a></button></li>\n";
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.budgets : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
